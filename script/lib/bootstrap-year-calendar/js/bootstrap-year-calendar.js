 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_renderBody: function() {
			...
			monthsDiv.addClass('row p-2');
			monthsDiv.addClass('months-container');
			
			for(var m = 0; m < 12; m++) {
				/* Container */
				var monthDiv = $(document.createElement('div'));
				//monthDiv.addClass('col border p-2');
				//monthDiv.addClass('col-xl-2 col-lg-3 col-md-4 col-sm-6 p-2');
				monthDiv.addClass('col-lg-3 col-md-4 col-sm-6 p-2');
